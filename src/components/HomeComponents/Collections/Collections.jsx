...
let Collections = () => {
    return <div className={css.outerDiv}>
        ...
        <div className={css.tagLine}>
            ...
            <span className={css.collectionPlacesTag}>All collections in Mullana <span className={css.rightArrowBox}><img className={css.rightArrow} src={rightArrow} alt="right arrow" /></span></span>
        </div>
